...
(define (eval-if c thn els env)
  (let* ([r1 (evaluate c env)])
    (if (boolean? (car r1)) (if (car r1) (evaluate thn (cdr r1)) (evaluate els (cdr r1))) (error "The conditon is not a boolean value"))))
